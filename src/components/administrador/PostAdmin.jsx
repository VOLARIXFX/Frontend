            ...
            <div className={`flex h-screen ${darkMode ? 'bg-[#0B0F18]' : 'bg-gray-100'} text-gray-900 dark:text-white`}>
                ...
                <div className="flex-1  overflow-y-auto p-6">
                    <div className={`flex flex-col md:flex-row justify-between items-start md:items-center mb-6 ml- space-y-4 md:space-y-0 ${darkMode ? 'bg-gray-800' : 'bg-white'} p-6 rounded-xl shadow-lg`}>
                        <div>
                            <h1 className={` text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Operaciones Registradas</h1>
                            <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'} mt-2`}>
                                {filtroActivo 
                                    ? posts.length > 0 
                                        ? `Mostrando ${posts.length} operaciones del ${formatearFecha(fechaPost.fecha_post)}`
                                        : `No hay operaciones registradas para el ${formatearFecha(fechaPost.fecha_post)}`
                                    : `Mostrando ${todosLosPosts.length} operaciones en total`
                                }
                            </p>
                        </div>
                        <div className="flex space-x-4">
                            ...
                            >
                                ...
                                {mostrarFiltro ? 'Ocultar Filtro' : 'Filtrar por Fecha'}
                            </button>
                        </div>
                    </div>
                                    ...
                                    >
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 mb-4">
                                                <div>
                                                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Precio Apertura</p>
                                                    <p className={`font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>{formatearNumero(post.precio_apertura)}</p>
                                                </div>
                                                <div>
                                                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Precio Cierre</p>
                                                    <p className={`font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>{formatearNumero(post.precio_cierre)}</p>
                                                </div>
                                                <div>
                                                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Stop Loss</p>
                                                    <p className={`font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>{formatearNumero(post.stop_loss)}</p>
                                                </div>
                                                <div>
                                                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Take Profit</p>
                                            ...
                                            <div className="flex items-center justify-between mb-4">
                                                <div>
                                                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Resultado</p>
                                                    <span className={`font-medium ${
                                                        ...
                                                        {post.resultado === 'ganancia' ? 'Ganancia' : 
                                                         post.resultado === 'perdida' ? 'Pérdida' : 
                                                         post.resultado === 'breakeven' ? 'Breakeven' : '--'}
                                                    </span>
                                                </div>
                                                <div className="mr-24">
                                                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Profit</p>
                                            ...
                                            {post.notas && (
                                                <div className={`mt-4 pt-4 border-t ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                                                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Notas</p>
