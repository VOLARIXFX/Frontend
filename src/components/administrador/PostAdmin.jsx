    ...
    <>
      ...
      <div
        className={`flex h-screen ${
          darkMode ? "bg-[#0B0F18]" : "bg-gray-100"
      ...
      >
        ...
        <div className="flex-1  overflow-y-auto p-6">
          <div
            className={`flex flex-col md:flex-row justify-between items-start md:items-center mb-6 ml- space-y-4 md:space-y-0 ${
          ...
          >
              ...
              >
                {filtroActivo
                  ? posts.length > 0
                    ? `Mostrando ${
                        posts.length
                      } operaciones del ${mostrarFecha(fechaPost.fecha_post)}`
                    : `No hay operaciones registradas para el ${mostrarFecha(
            ...
            <div className="flex space-x-4">
              {filtroActivo &&
                (todosLosPosts.length > 0 || posts.length > 0) && (
                  <button
          ...
          {mostrarFiltro && (
            <div
              className={`${
                darkMode ? "bg-gray-800" : "bg-white"
              } p-6 rounded-lg shadow-lg mb-6 max-w-md mx-auto transform transition-all duration-300 ease-in-out border ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
            {loading || loadingFiltro ? (
              ...
              <div className="col-span-full text-center py-12">
                ...
                >
                  {filtroActivo
                    ? t("no_operaciones_fecha", {
                        fecha: mostrarFecha(fechaPost.fecha_post),
                      })
              ...
              currentPosts.map((post, index) => (
                <div
                  ...
                  className={`${
                    darkMode ? "bg-gray-800" : "bg-white"
                  } rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-[1.02] border ${
                    darkMode ? "border-gray-700" : "border-gray-200"
                  }`}
                >
                  {post.imagen && (
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        >
                          {formatearNumero(post.precio_apertura)}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        >
                          {formatearNumero(post.stop_loss)}
                        </p>
                      </div>
                      <div>
                        <p
                        ...
                        >
                          {formatearNumero(post.take_profit)}
                        </p>
                      </div>
                    </div>
